...
public class GameCalculator {
    ...
    public Pitcher getRandomPitcherInfo(){
        float f = (float) Math.random() * gameData.pitcherList.size();
        return gameData.pitcherList.get((int) f);
    }

    public Hitter getRandomHitterInfo(){
        float f = (float) Math.random() * gameData.hitterList.size();
        return gameData.hitterList.get((int) f);
    }
}
